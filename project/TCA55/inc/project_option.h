...
#define RESOLUTION_LIST                                               \
	{"2880X1620", "H265+", 0, 4000, 500, 6000, 25, 5, 25, 0, 0, 25},  \
	{"2560X1440", "H265+", 0, 3500, 500, 6000, 25, 5, 25, 0, 0, 25},  \
	{"2304X1296", "H265+", 0, 3000, 500, 6000, 25, 5, 25, 0, 0, 25},  \
	{"1080P",     "H265+", 0, 2500, 200, 8000, 25, 5, 25, 1, 0, 25},  \
	{"720P",      "H265+", 0, 1500, 100, 5000, 25, 5, 25, 1, 0, 25},  \
	{"800X448",   "H265+", 1, 500,  50,  1000, 25, 5, 25, 0, 0, 25},  \
	{"D1",        "H265+", 1, 500,  50,  1000, 25, 5, 25, 0, 0, 25},  \
	{"VGA",       "H265+", 1, 500,  50,  1000, 25, 5, 25, 0, 0, 25},  \
	{"640X360",   "H265+", 1, 500,  50,  1000, 25, 5, 25, 0, 0, 25},  \
	{"480X360",   "H265+", 1, 500,  50,  1000, 25, 5, 25, 0, 0, 25},  \
	{"CIF",       "H265+", 1, 150,  50,  2000, 25, 5, 25, 0, 0, 25},  \
	{"2880X1620", "H265",  0, 4000, 500, 6000, 25, 5, 25, 0, 1, 25},  \
	{"2560X1440", "H265",  0, 3500, 500, 6000, 25, 5, 25, 0, 0, 25},  \
	{"2304X1296", "H265",  0, 3000, 500, 6000, 25, 5, 25, 0, 0, 25},  \
	{"1080P",     "H265",  0, 2500, 200, 8000, 25, 5, 25, 1, 0, 25},  \
	{"720P",      "H265",  0, 1500, 100, 5000, 25, 5, 25, 1, 0, 25},  \
	...
	{"480X360",   "H265",  1, 500,  50,  1000, 25, 5, 25, 0, 0, 25},  \
	{"CIF",       "H265",  1, 150,  50,  2000, 25, 5, 25, 0, 0, 25},  \
	{"2880X1620", "H264",  0, 4000, 500, 8000, 25, 8, 25, 0, 0, 25},  \
	{"2560X1440", "H264",  0, 3500, 500, 8000, 25, 5, 25, 0, 0, 25},  \
	{"2304X1296", "H264",  0, 3000, 500, 8000, 25, 5, 25, 0, 0, 25},  \
	{"1080P",     "H264",  0, 2500, 200, 9000, 25, 5, 25, 1, 0, 25},  \
	{"720P",      "H264",  0, 1500, 100, 6000, 25, 5, 25, 1, 0, 25},  \
	{"800X448",   "H264",  1, 500,  50,  2000, 25, 5, 25, 0, 0, 25},  \
	{"D1",        "H264",  1, 500,  50,  2000, 25, 5, 25, 0, 0, 25},  \
	{"VGA",       "H264",  1, 500,  50,  2000, 25, 5, 25, 0, 0, 25},  \
	{"640X360",   "H264",  1, 500,  50,  2000, 25, 5, 25, 0, 0, 25},  \
	{"480X360",   "H264",  1, 500,  50,  2000, 25, 5, 25, 0, 0, 25},  \
	{"CIF",       "H264",  1, 150,  50,  2000, 25, 5, 25, 0, 0, 25},  \
...
#define RESOLUTION_MAX_WIDTH (2880)
...
#define ISP_AI_BIN_PATH "/config/iqfile/calibration_sc4336_aiisp.bin"
#define ISP_AI_IR_BIN_PATH "/config/iqfile/calibration_sc4336_aiisp_ir.bin"
#define ISP_DEFAUT_AE_TARGET (0)
...
/* 硬光敏物理电平：亮环境对应值（TCA55：亮=高、暗=低） */
#define ANJ_PHOTO_SENSOR_BRIGHT_LEVEL           (1)
