...
#define ANJ_PROJECT_NAME "MYF30"
#define ANJ_CUSTOMER_TYPE (CUSTOMER_NORMAL)
#define ANJ_PROJECT_SENSOR (SENSOR_TYPE_SP4329)
#define ANJ_PROJECT_TYPE (PROJECT_TYPE_LP)
#define ANJ_DEVICE_TYPE ""
#define ANJ_CRYPT_NAME "NULL"
#define ANJ_CAMERA_MAX_NUMS (1)
#define MAX_SCL_PORT (3)
...
#define RESOLUTION_LIST                                             \
    {"2880X1620", "H265+", 0, 3500, 500, 6000, 25, 5, 25, 0, 0, 25},\
    ...
    {"2880X1620", "H265", 0, 3500, 500, 6000, 25, 5, 25, 0, 1, 25}, \
...
#define BUFSZIE_VENC0_COEF 10 / 40
#define BUFSZIE_VENC1_COEF 15 / 37
...
#define ANJ_GPIO_PORT_SWITCH_AUDIOOUT           43
#define ANJ_GPIO_PORT_MOTOT_SEL                 60
#define ANJ_GPIO_PORT_SWITCH_LED                61
#define ANJ_GPIO_PORT_ALARM_LED                 74
#define ANJ_GPIO_PORT_SWITCH_SIMCARD            0
#define ANJ_GPIO_PORT_USB_POWER                 42
...
#define ANJ_EXPAND_DEV_GPIO         (0)
#define ANJ_EXPAND_I2C_GPIO         (0)
...
#define SMART_PD_MODEL_PATH "/config/dla/model/sypcny48_V3.10_20230810_fixed.sim_sgsimg.img"
#define DEFAULT_SMART_WIDTH (800)
#define DEFAULT_SMART_HEIGHT (480)
#define DEFAULT_SMART_FPS (5)
#define DEFAULT_SMART_DEPTH (3)
