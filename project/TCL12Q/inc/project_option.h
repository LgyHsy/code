...
#define ANJ_PROJECT_NAME "TCL12Q"
#define ANJ_CUSTOMER_TYPE (CUSTOMER_NORMAL)
#define ANJ_PROJECT_SENSOR (SENSOR_TYPE_OS05A20)
...
// #define PRODCUT_CODE "cmcc" "IPC2CHN" "IPC2CHN4G"
#define PRODCUT_CODE "public"

//***********************************设备网络相关配置***********************************//
#define IPC_NETWORK_TYPE (NET_DEV_TYPE_WIRE)
...
#define RESOLUTION_LIST                                               \
	{"2592X1944", "H265+", 0, 4000, 500, 6000, 30, 5, 30, 0, 0, 30},  \
	{"2560X1440", "H265+", 0, 3500, 500, 6000, 30, 5, 30, 0, 0, 30},  \
	{"2304X1296", "H265+", 0, 3000, 500, 6000, 30, 5, 30, 0, 0, 30},  \
	{"1080P",     "H265+", 0, 2500, 200, 8000, 30, 5, 60, 1, 0, 60},  \
	{"720P",      "H265+", 0, 1500, 100, 5000, 30, 5, 30, 1, 0, 30},  \
	{"D1",        "H265+", 1, 500,  50,  1000, 30, 5, 30, 0, 0, 30},  \
	{"VGA",       "H265+", 1, 500,  50,  1000, 30, 5, 30, 0, 0, 30},  \
	{"640X360",   "H265+", 1, 500,  50,  1000, 30, 5, 30, 0, 0, 30},  \
	{"480X480",   "H265+", 1, 500,  50,  1000, 30, 5, 30, 0, 0, 30},  \
	{"480X360",   "H265+", 1, 500,  50,  1000, 30, 5, 30, 0, 0, 30},  \
	{"CIF",       "H265+", 1, 150,  50,  2000, 30, 5, 30, 0, 0, 30},  \
	{"2592X1944", "H265",  0, 4000, 500, 6000, 30, 5, 30, 0, 1, 30},  \
	{"2560X1440", "H265",  0, 3500, 500, 6000, 30, 5, 30, 0, 0, 30},  \
	{"2304X1296", "H265",  0, 3000, 500, 6000, 30, 5, 30, 0, 0, 30},  \
	{"1080P",     "H265",  0, 2500, 200, 8000, 30, 5, 60, 1, 0, 60},  \
	{"720P",      "H265",  0, 1500, 100, 5000, 30, 5, 30, 1, 0, 30},  \
	...
	{"480X360",   "H265",  1, 500,  50,  1000, 30, 5, 30, 0, 0, 30},  \
	{"CIF",       "H265",  1, 150,  50,  2000, 30, 5, 30, 0, 0, 30},  \
	{"2592X1944", "H264",  0, 4000, 500, 8000, 30, 8, 30, 0, 0, 30},  \
	{"2560X1440", "H264",  0, 4000, 500, 8000, 30, 5, 30, 0, 0, 30},  \
	{"2304X1296", "H264",  0, 3500, 500, 8000, 30, 5, 30, 0, 0, 30},  \
	{"1080P",     "H264",  0, 3000, 500, 9000, 30, 5, 60, 1, 0, 60},  \
	{"720P",      "H264",  0, 2500, 500, 6000, 30, 5, 30, 1, 0, 30},  \
	{"D1",        "H264",  1, 500,  50,  2000, 30, 5, 30, 0, 0, 30},  \
	{"VGA",       "H264",  1, 500,  50,  2000, 30, 5, 30, 0, 0, 30},  \
	{"640X360",   "H264",  1, 500,  50,  2000, 30, 5, 30, 0, 0, 30},  \
	{"480X480",   "H264",  1, 500,  50,  2000, 30, 5, 30, 0, 0, 30},  \
	{"480X360",   "H264",  1, 500,  50,  2000, 30, 5, 30, 0, 0, 30},  \
	{"CIF",       "H264",  1, 150,  50,  2000, 30, 5, 30, 0, 0, 30},  \
...
#define ANJ_CAMERA_MMA_SIZE "0x05300000"
...
#define RESOLUTION_MAX_WIDTH (2592)
#define RESOLUTION_MAX_HEIGHT (1944)
...
#define ISP_DAY_BIN_PATH "/config/iqfile/calibration_os05a20.bin"
#define ISP_NIGHT_BIN_PATH "/config/iqfile/calibration_os05a20_ir.bin"
#define ISP_WDR_BIN_PATH "/config/iqfile/calibration_os05a20_wdr.bin"
...
#define ALARM_SUPPORT_REGION_AI             (1)
#define ALARM_SUPPORT_VIDEO_COVERD          (0)
#define ALARM_SUPPORT_IO_IN                 (1)
#define ALARM_SUPPORT_IO_OUT                (1)
