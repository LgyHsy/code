			                 ...
			                 unsigned bufferSize, Boolean oneFilePerFrame) 
{
  do {
    ...
    return new H265VideoFileSink(env, fid, sPropParameterSetsStr, bufferSize, perFrameFileNamePrefix);
  } while (0);

  return NULL;
}

void H265VideoFileSink::afterGettingFrame1(unsigned frameSize, struct timeval presentationTime) 
{
