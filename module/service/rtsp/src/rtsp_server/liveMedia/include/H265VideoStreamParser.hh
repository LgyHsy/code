...
#ifndef _H265_VIDEO_STREAM_PARSER_HH
#define _H265_VIDEO_STREAM_PARSER_HH
...
////////// H265VideoStreamParser definition //////////
...
class H265VideoStreamParser: public StreamParser {
public:
  H265VideoStreamParser(H265VideoStreamFramer* usingSource,
			FramedSource* inputSource);
  virtual ~H265VideoStreamParser();
...
protected:
  void setParseState(H265ParseState parseState);
...
protected:
  H265VideoStreamFramer* fUsingSource;
...
private: // redefined virtual functions
  ...
  H265ParseState fCurrentParseState;
