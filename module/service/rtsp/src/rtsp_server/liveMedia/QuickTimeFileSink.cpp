...
#include "H264VideoRTPSource.hh" // for the special header
#include "RTPSource.hh" // for "parseGeneralConfigStr()"
#include "Base64.hh"

#include <ctype.h>

#ifndef SPECIAL_HEADER_BUFFER_SIZE
...
QuickTimeFileSink::QuickTimeFileSink(UsageEnvironment& env,
  ...
  SystemGetTimeofRun(&fStartTime, NULL);
