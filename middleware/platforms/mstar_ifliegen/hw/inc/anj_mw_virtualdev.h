...
#define VIRDEV_MOTOR_SYSFS_PATH "/sys/devices/virtual/sgs/pwm"

// 设置组模式
int anj_virdev_motor_set_group_join(int pwm_id, int mode);
...
// 设置组开始时间
int anj_virdev_motor_set_group_duty(int pwm_id, int shift);
