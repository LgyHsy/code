...
MI_S32 ST_Common_VencCreateChannel(ST_Common_VencAttr_t *pVencAttr)
{
    ...
    case E_MI_VENC_MODTYPE_H264E:
    {
        ...
        else if (stVencChnAttr.stRcAttr.eRcMode == E_MI_VENC_RC_MODE_H264VBR)
        {
            ...
            stRcParam.stParamH264VBR.u32MaxQp = pVencAttr->u32MaxQp;
            stRcParam.stParamH264VBR.u32MinQp = pVencAttr->u32MinQp;
        ...
        else if (stVencChnAttr.stRcAttr.eRcMode == E_MI_VENC_RC_MODE_H264AVBR)
        {
            ...
            stRcParam.stParamH264Avbr.u32MaxQp = pVencAttr->u32MaxQp;
            stRcParam.stParamH264Avbr.u32MinQp = pVencAttr->u32MinQp;
            stRcParam.stParamH264Avbr.u32MaxIPProp = 12;
            stRcParam.stParamH264Avbr.s32IPQPDelta = -4;
    ...
    case E_MI_VENC_MODTYPE_H265E:
    {
        ...
        else if (stVencChnAttr.stRcAttr.eRcMode == E_MI_VENC_RC_MODE_H265VBR)
        {
            ...
            stRcParam.stParamH265Vbr.u32MaxQp = pVencAttr->u32MaxQp;
            stRcParam.stParamH265Vbr.u32MinQp = pVencAttr->u32MinQp;
            stRcParam.stParamH265Vbr.u32MaxIPProp = 0;
        ...
        else if (stVencChnAttr.stRcAttr.eRcMode == E_MI_VENC_RC_MODE_H265AVBR)
        {
            ...
            stRcParam.stParamH265Avbr.u32MaxQp = pVencAttr->u32MaxQp;
            stRcParam.stParamH265Avbr.u32MinQp = pVencAttr->u32MinQp;
...
MI_S32 ST_Common_VencGetStream(MI_VENC_CHN VencChn, MI_VENC_ModType_e eVencType, ST_Common_Venc_DataCb datacb, int *bStart)
{
    ...
    STCHECKRESULT(MI_VENC_StopRecvPic(VencDevId, VencChn));
